...
import { forgotPassword, getErrorMessage } from "../../services/authApi";
  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-md rounded-2xl bg-[#1e1e20] p-8 shadow-2xl ring-1 ring-white/5">
        <h2 className="mb-6 text-2xl font-medium text-white">Forgot Password</h2>
          ...
          <div className="space-y-2">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/5 bg-[#2a2a2b] pl-10 pr-4 py-3 text-sm text-white placeholder-zinc-500 focus:border-teal-400/50 focus:outline-none"
